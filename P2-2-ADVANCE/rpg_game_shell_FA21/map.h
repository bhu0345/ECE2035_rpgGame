...
void add_door(int u, int v);
void add_crown(int u, int v);
void add_keyy(int u, int v);
void add_opendoor(int u, int v);
void add_monster(int u, int v);
void add_NPC2(int u, int v);
void add_cure(int u, int v);
void add_poison(int u, int v);
void add_monster2(int u, int v);
void add_ex(int u, int v);
void add_qu(int u, int v);
void add_shield(int u, int v);
void add_hammer(int u, int v);
#endif //MAP_H